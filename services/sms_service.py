...
class SMSService:
    def __init__(self):
        ...
        self.area_contacts = {
            1: ["+919962219859", "+918148909596"],  # Area 1 contacts
            2: ['+919962219859', "+916379390238"],  # Area 2 contacts
            3: ["+916385712937", "+919962219859"]  # Area 3 contacts
        }

        # General emergency contacts (for system-wide alerts)
        self.emergency_contacts = [
            '+919962219859',  # System administrator
            '+919962219859'  # Backup contact
        ]
