...
const int MQ4_PIN_1 = 34;  // GPIO34 (A0)
const int MQ4_PIN_2 = 35;  // GPIO35 (A1)
const int MQ4_PIN_3 = 32;  // GPIO32 (A2)

// MQ-7 Gas Sensors (Carbon Monoxide)
const int MQ7_PIN_1 = 33;  // GPIO33 (A3)
const int MQ7_PIN_2 = 36;  // GPIO36 (A4)
const int MQ7_PIN_3 = 39;  // GPIO39 (A5)

// DHT11 Temperature & Humidity Sensors
const int DHT_PIN_1 = 4;   // GPIO4
const int DHT_PIN_2 = 16;  // GPIO16
const int DHT_PIN_3 = 17;  // GPIO17

// Ultrasonic Sensor (HC-SR04)
const int TRIG_PIN = 25;   // GPIO25
const int ECHO_PIN = 26;   // GPIO26

// Other sensors
const int SOIL_MOISTURE_PIN = 27;  // GPIO27 (A6)
const int VIBRATION_PIN = 14;      // GPIO14
const int IR_SENSOR_PIN = 13;      // GPIO13
const int BUZZER_PIN = 23;         // GPIO23
...
void sendDataToServer() {
  ...
  // Gas sensor data
  doc["mq4_1"] = currentData.mq4_1;
  doc["mq4_2"] = currentData.mq4_2;
  doc["mq4_3"] = currentData.mq4_3;
  doc["mq7_1"] = currentData.mq7_1;
  doc["mq7_2"] = currentData.mq7_2;
  doc["mq7_3"] = currentData.mq7_3;

  // Environmental data
  doc["temperature"] = currentData.temperature;
  doc["humidity"] = currentData.humidity;
  doc["ultrasonic_distance"] = currentData.ultrasonic_distance;
